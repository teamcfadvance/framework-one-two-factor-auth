...
component accessors="true" {
    ...
    */ 
	public void function process( rc ) {
		...
		var qGetUser = '';
		var fieldList = 'username,password,confirm,firstName,lastName,providerId,phone';
		var ix = 0;
		...
		if( qGetUser.recordCount ) {
			...
			variables.fw.redirect( action = 'main.register', queryString = "msg=#urlEncodedFormat( 'An account already exists for this email address. Please log in.' )#" );			
		}
